...
(function (window, document) {
    ...
    function inNodeList (needle, haystack) {
    ...
    MediumEditor.prototype = {
        ...
        init: function (selector, options) {
            ...
            // any custom buttons should be added to the parentElements
            for (var i = 0; i < options.buttons.length; ++i) {
                var b = options.buttons[i];
                if (this.parentElements.indexOf(b.tag) == -1) {
                    this.parentElements.push(b.tag);
                }
            }
        ...
        initElements: function (selector) {
            ...
            for (i = 0; i < this.elements.length; i += 1) {
                ...
                this.elements[i].onpaste = handlepaste;
        ...
        toolbarTemplate: function () {
            var template =  '<ul id="medium-editor-toolbar-actions" class="medium-editor-toolbar-actions clearfix">' +
            ...
            for (var i = 0; i < this.options.buttons.length; ++i) {
                ...
                template += '<li><button class="medium-editor-action medium-editor-action-'+b.tag+'" data-action="append-'+b.tag+'" data-element="'+b.tag+'">'+b.label+'</button></li>'
            }
        ...
        setToolbarPosition: function () {
            ...
            var left = Math.max(((boundary.left + boundary.right) / 2) - (this.toolbar.offsetWidth / 2) + (this.options.diffLeft), 0);
        ...
        appendEl: function (el) {
            ...
            while (this.parentElements.indexOf(tagName) === -1 &&
                   !inNodeList(selectionEl.parentNode, this.elements)) {
            ...
            el.innerHTML = selectionEl.innerHTML || selectionEl.textContent;
        ...
        transferAttributes: function (elFrom, elTo) {
            elFrom.attributes && Array.prototype.slice.call(elFrom.attributes).forEach(function(item) {
